...
public class Detect {
    ...
    // Generate authentication checksum token
    public static String getChecksum(String appSecret, String nonce, String curTime) {
        return encode("sha1", appSecret + nonce + curTime);
    }

    // Generate SHA1 encoding
    ...
    // Compose submit task request body
    ...
    // Compose stop task request body
    public static String getStopBody() {
        ...
        chanObj.put("status", 100); // fixed value 100
    ...
    // Stop Task Example:
    public static void StopDetectTask() throws Exception {
    ...
    // Submit Task Example:
    public static void SubmitDetectTask() throws Exception {
    ...
    // 1. Prepare your account appkey and app secret, and set as environment
    // variables:
    // export APPKEY=<your-app-key>
    // export APPSECRET=<your-app-secret>

    // 2. Start a room, and replace all `TO BE REPLACED` sections above
